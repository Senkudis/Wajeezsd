...
## 7. أسئلة مفتوحة تحتاج قراراً

1. **البند الخامس ("Something else")** الذي أضفته في الاختيار — ما هو بالضبط؟
   (فروع متعددة؟ موظفون/صلاحيات داخل المتجر؟ موردون وأوامر شراء؟ فواتير PDF؟)
2. هل المصروفات تُخصم من رصيد محفظة المتجر (`shopWalletBalance`) أم تُسجَّل للتقارير فقط؟
3. رصيد المتجر: هل يمثل نقداً فعلياً لدى التاجر أم مستحقات لدى التطبيق؟
   (يحدد إن كنا نحتاج نظام تسويات/سحب.)
