...
const UserSchema = new mongoose.Schema(
    {
        ...
        // 🔒 إبطال الجلسات. يُدرَج في الـ JWT باسم `tv` ويُقارَن في protect،
        //    فرفعه يُسقط كل التوكنات الصادرة قبله فوراً. يُرفع عند: تغيير كلمة
        //    المرور (استعادةً أو من الإدارة)، حذف الحساب، و"خروج من كل الأجهزة".
        //    بدونه كان التوكن المسروق يبقى صالحاً سبعة أيام ولو غُيّرت كلمة المرور.
        //    التوكنات القديمة بلا `tv` تُعامَل كـ 0 — فتبقى صالحة حتى أول رفع،
        //    وإلا خرج كل المستخدمين عند النشر.
