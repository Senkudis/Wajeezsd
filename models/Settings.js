...
const settingsSchema = new mongoose.Schema({
    ...
    // 💚 أقصى إكرامية يقبلها النظام في الطلب الواحد.
    // سقفٌ لا حظر: الغرض حماية العميل من خطأ إدخال (صفرٌ زائد يجعل ٥٠٠ خمسة
    // آلاف) لا تحجيم كرمه. صفر = تعطيل الإكرامية في هذه المدينة كلياً.
    maxTipAmount: {
        type: Number,
        default: 20000,
        min: 0,
